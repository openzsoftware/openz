...
public class CancelLogout  extends HttpSecureAppServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
      ...
      try{
        ...
        String strcancellogoutfg=""; //Navigation Fieldgroup (Barcode Field and Buttons)
        
        String strmsg = Utility.messageBD(this, "SC_cancellogout",vars.getLanguage());
        ...
        strSkeleton = ConfigureFrameWindow.doConfigure(this,vars,"inpcancellogout",null, "Initial CancelLogout",strToolbar,"NONE",tabs);
        ...
        strcancellogoutfg=fh.prepareFieldgroup(this, vars, script, "SC_cancellogout_fg", null,false);
        ...
        strOutput=Replace.replace(strSkeleton, "@CONTENT@",strcancellogoutfg + strinfo + strButtonsFG);
