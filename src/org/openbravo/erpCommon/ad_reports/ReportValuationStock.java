...
public class ReportValuationStock extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT", "RELATION")) {
      String strDate = vars.getDateParameterGlobalVariable("inpDate", "ReportValuationStock|Date",  UtilsData.selectDisplayDatevalue(this,vars.getSessionValue("#DATE"), "DD-MM-YYYY", vars.getSessionValue("#AD_SqlDateFormat")),this);
  ...
  private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response,
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      xmlDocument.setParameter("date",  UtilsData.selectDisplayDatevalue(this,strDate, "DD-MM-YYYY", vars.getSessionValue("#AD_SqlDateFormat")));
