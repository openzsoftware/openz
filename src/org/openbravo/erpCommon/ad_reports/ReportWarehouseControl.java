...
public class ReportWarehouseControl extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDateFrom = vars.getDateParameterGlobalVariable("inpDateFrom", "ReportWarehouseControl|DateFrom",
          "",this);
      String strDateTo = vars.getDateParameterGlobalVariable("inpDateTo", "ReportWarehouseControl|DateTo", "",this);
      ...
      String strDateFrom = vars.getDateParameterGlobalVariable("inpDateFrom",
          "ReportWarehouseControl|DateFrom",this);
      String strDateTo = vars
          .getDateParameterGlobalVariable("inpDateTo", "ReportWarehouseControl|DateTo",this);
