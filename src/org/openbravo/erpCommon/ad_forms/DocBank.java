...
public class DocBank extends AcctServer {
  ...
  public Fact createFact(AcctSchema as, ConnectionProvider conn, Connection con,
    ...
    for (int i = 0; p_lines != null && i < p_lines.length; i++) {
      ...
      if (DocBankData.isDownPayment(conn, line.m_C_Payment_ID).equals("Y") && 
    		  getAccount(AcctServer.ACCTTYPE_DownPayClearing, as, conn)!=null)
    	  DocBankData.BankStmtDownPaymentReceivedAndTaxes(con, conn, line.m_TrxLine_ID, line.m_DateAcct,vars.getUser());
      //  
      ...
      // Break down in Charge and Transaction Amount
        ...
        // Charge DR (Charge)
        // Charge occurs in Payments and Receipts and is always negative
        if (ChargeAmt.compareTo(BigDecimal.ZERO)==-1)
