      ...
      if (!strcOrderLineId.equals("")) {
        ...
        while (st.hasMoreTokens()) {
          ...
          if (! (dataLine[0].mProductUomId.equals(""))) {
            ...
            qty2UOMOrder=qty2UOMOrder.setScale(2, RoundingMode.HALF_UP);
            qtyOrdered=qtyOrdered.setScale(2, RoundingMode.HALF_UP);
            qtyOrder=qtyOrder.setScale(2, RoundingMode.HALF_UP);
