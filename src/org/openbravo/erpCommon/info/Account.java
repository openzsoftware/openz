...
public class Account extends HttpSecureAppServlet {
  ...
  private static final String[] colNames = { "ALIAS", "COMBINATION", "DESCRIPTION", 
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      if (AccountData.isCompleteCombination(this, strNameValue).equals("Y")) {
    	  strNameValue ="";
    	  vars.removeSessionValue("Account.combination");
      }
      String strAcctSchema = vars.getStringParameter("inpAccount");
      if (strAcctSchema.isEmpty())
    	  strAcctSchema = vars.getSessionValue(strWindowId + "|C_AcctSchema_ID");
      ...
      vars.setSessionValue("Account.account",strAcctSchema);
      ...
      printGridData(response, vars, strAlias, strCombination, strOrganization, "",
      ...
      if (AccountData.isCompleteCombination(this, strKeyValue).equals("Y"))
    	  strKeyValue ="";
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strAlias,
    ...
    if (isDefault) {
      if (strAlias.equals("") && strCombination.equals(""))
        strAlias = "%";
      data = AccountData.set(strAlias, strCombination,strAcctSchema);
    } else {
...
*/
    try {
      /*
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLE", "C_ValidCombination_ID",
          "C_ValidCombination", null, Utility.getContext(this, vars,
  ...
  private SQLReturnObject[] getHeaders(VariablesSecureApp vars) {
    ...
    String[] colWidths = { "55", "240", "220", "220", "71", "-1", "43", "59", "0", "0" };
