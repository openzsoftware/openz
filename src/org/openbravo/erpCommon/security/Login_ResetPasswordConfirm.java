...
public class Login_ResetPasswordConfirm extends HttpBaseServlet {
  ...
  private void printPageIdentificacion(HttpServletResponse response,HttpServletRequest request, String strTheme, String permsession)
	...
	XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/security/Login_ResetPasswordConfirm").createXmlDocument();
    ...
    //translation
    xmloutput = xmloutput
            .replaceAll("@passwordresetconfirmtext@", Utility.messageBD(this, "passwordresetconfirmtext", lang))
