...
public class CreateFile extends HttpSecureAppServlet {
  ...
  private void printPageFind58(HttpServletResponse response, VariablesSecureApp vars,
    ...
    int comprobacion1 = Integer.valueOf(CreateFileData.selectComprobacion1(this, strKey)).intValue();
    int comprobacion2 = Integer.valueOf(CreateFileData.selectComprobacion2(this, strKey)).intValue();
    int comprobacion3 = Integer.valueOf(CreateFileData.selectComprobacion3(this, strKey)).intValue();
    int comprobacion4 = Integer.valueOf(CreateFileData.selectComprobacion4(this, strKey)).intValue();
