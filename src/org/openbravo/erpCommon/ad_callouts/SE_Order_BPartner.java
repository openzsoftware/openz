...
public class SE_Order_BPartner extends HttpSecureAppServlet {
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strBPartner,
    ...
    if (data != null && data.length > 0) {
      ...
      strIncoterms = data[0].cIncotermsId;
    ...
    if (strMwarehouse.equals(""))
        strMwarehouse = vars.getStringParameter("inpmWarehouseId");
    if (strMwarehouse.equals(""))
    ...
    if (data != null && data.length > 0 &&
            data[0].internalnote != null && !data[0].internalnote.isEmpty()
            && strIsSOTrx.equals("Y")) {
          if (message.length() > 0)
            message.append("<br>");
          String internalnote = data[0].internalnote;
