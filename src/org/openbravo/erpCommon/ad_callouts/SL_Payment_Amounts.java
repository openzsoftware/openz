  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strChanged,
    ...
    if (strChanged.equals("inpisoverunderpayment")) {
      ...
      if (strCurrency.equals("")) {
        ...
        if (strCurrency.equals(strcCurrencyId)) {
          ...
          if (strconvert.equals("")) {
            ...
            BigDecimal temp1 = payamt.multiply(convert).setScale(2, 4);
            payamt = temp1;
            resultado.append("new Array(\"inppayamt\", " + payamt.toString() + "),");
            @SuppressWarnings( "deprecation" )
            BigDecimal temp2 = discountamt.multiply(convert).setScale(2, 4);
            discountamt = temp2;
            resultado.append("new Array(\"inpdiscountamt\", " + discountamt.toString() + "),");
            @SuppressWarnings( "deprecation" )
            BigDecimal temp3 = writeoffamt.multiply(convert).setScale(2, 4);
            writeoffamt = temp3;
            resultado.append("new Array(\"inpwriteoffamt\", " + writeoffamt.toString() + "),");
            @SuppressWarnings( "deprecation" )
            BigDecimal temp4 = overunderamt.multiply(convert).setScale(2, 4);
            overunderamt = temp4 ;
            resultado.append("new Array(\"inpoverunderamt\", " + overunderamt.toString() + ")");
            vars.setSessionValue("Last.Currency", strcCurrencyId);
          }
      ...
      if (strcCurrencyId.equals(data[0].currencyid)) {
        ...
        convert = new BigDecimal(strconvert);
        @SuppressWarnings( "deprecation" )
        BigDecimal temp5 = invtotamt.multiply(convert).setScale(2, 4);
        invtotamt = temp5;
      }
      ...
      if (strcCurrencyId.equals(data[0].currencyid)) {
        ...
        convert = new BigDecimal(strconvert);
        @SuppressWarnings( "deprecation" )
        BigDecimal temp6 = invtotamt.multiply(convert).setScale(2, 4);
        invtotamt =  temp6;
      }
      ...
      if (strcCurrencyId.equals(data[0].currencyid)) {
        ...
        convert = new BigDecimal(strconvert);
        @SuppressWarnings( "deprecation" )
        BigDecimal temp7 = invtotamt.multiply(convert).setScale(2, 4);;
        invtotamt = temp7;
      }
