...
public class PrintAssets extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintAssets.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = new DocumentType("ASSETS","A_ASSET","assets/","Asset",false,"PrintOptionsAssets","c_getDefaultDocInfo");
    ...
    // AD_PROCESS
    String sessionValuePrefix = "PRINTASSETS";
    String strDocumentId = null;

    
    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpaAssetId_R");
    if (strDocumentId.equals(""))
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpaAssetId");
