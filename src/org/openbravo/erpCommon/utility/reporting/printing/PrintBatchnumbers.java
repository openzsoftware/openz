...
public class PrintBatchnumbers extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintBatchnumbers.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = new DocumentType("BATCHNUMBER","SNR_BATCHMASTERDATA","batchnumber/","Batchnumber",false,null,"c_getDefaultDocInfo");
    // The prefix PRINTORDERS is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTBATCHNUMBERS";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsnrBatchmasterdataId_R");
    if (strDocumentId.equals(""))
      strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpsnrBatchmasterdataId");
