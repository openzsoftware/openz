...
public class PrintInternalMaterialMovement extends PrintController {
  private static Logger log4j = Logger.getLogger(PrintInternalMaterialMovement.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    DocumentType documentType = new DocumentType("INTERNALMOVEMENT","M_INTERNAL_CONSUMPTION","internalmovement/","InternalConsumptionAndReturn",false,null,"c_getDefaultDocInfo");
    // The prefix PRINTSHIPMENTS is a fixed name based on the KEY of the
    // AD_PROCESS
    String sessionValuePrefix = "PRINTINTERNALMOVEMENT";
    String strDocumentId = null;

    strDocumentId = vars.getSessionValue(sessionValuePrefix + ".inpmInternalConsuptionId_R");
