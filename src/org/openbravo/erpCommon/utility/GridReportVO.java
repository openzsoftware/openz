...
class GridReportVO {
  ...
  public GridReportVO(String jrxmlTemplate, FieldProvider[] fieldProvider, String title,
      List<?> columns, String context, int totalWidth, String strDateFormat, String strSumText) {
    super();
    ...
    this.headerBandStyle = new BandStyleVO(null, new Color(0,0,0), 10, true, false, false);
    this.detailBandStyle = new BandStyleVO(null , new Color(0,0,0), 10, false, false, false);
    this.totalWidth = totalWidth;
    this.strDateFormat = strDateFormat;
    this.sumtext=strSumText;
  }
