...
public class EnterPasswordServlet extends HttpSecureAppServlet {
  ...
  ServletException {
    ...
    if (vars.commandIn("SAVE")) {
      try {
        ...
        MfaChangePasswordData.setPassword(myPool, FormatUtilities.sha1Base64(unhashedpassword), adUserId_loggedin, adUserID);
        SeguridadData.resetOTPassword(myPool, adUserId_loggedin, adUserID);
    ...
    try {
      ...
      strOutput = ConfigurePopup.doConfigure(this,vars,script,"Enter_Password","password");
      
      strHeaderFG=fh.prepareFieldgroup(this, vars, script,"EnterPasswordServletFG", null, false); 
      strActionButtons=fh.prepareFieldgroup(this, vars, script,"EnterPasswordServletFGAction", null, false); 
