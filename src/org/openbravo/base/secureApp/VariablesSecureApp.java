...
public class VariablesSecureApp extends VariablesBase {
  ...
  public String getDateParameterGlobalVariable(String parameter, String sessionAttribute, ConnectionProvider conn) throws ServletException {
	    ...
	    String value = getStringParameter(parameter); //getGlobalVariable(parameter, sessionAttribute, false, false, false, "", null);
	    String targetvalue=value;
	    Boolean isTime=false;
	    if (!value.isEmpty() && value.substring(2, 3).equals(":") && value.substring(5, 6).equals(":") &&  value.length()==8)
	    	isTime=true;
  ...
  public String getDateParameterGlobalVariable(String parameter, String sessionAttribute, String defval,ConnectionProvider conn) throws ServletException {
	    ...
	    String value = getStringParameter(parameter); //getGlobalVariable(parameter, sessionAttribute, false, false, false, defval, null);
	    String targetvalue=value;
	    Boolean isTime=false;
	    if (!value.isEmpty() && value.substring(2, 3).equals(":") && value.substring(5, 6).equals(":") &&  value.length()==8)
	    	isTime=true;
  ...
  public String getDateParameterGlobalVariableAndFetchFromSessionIfEmpty(String parameter, String sessionAttribute, ConnectionProvider conn) throws ServletException {
	  
	    String value = getStringParameter(parameter); //getGlobalVariable(parameter, sessionAttribute, false, false, false, "", null);
	    String targetvalue;
	    if (value.isEmpty())
	    	targetvalue=getSessionValue(sessionAttribute);
	    else
	    	targetvalue=value;
	    Boolean isTime=false;
	    if (!value.isEmpty() && value.substring(2, 3).equals(":") && value.substring(5, 6).equals(":") &&  value.length()==8)
...
public String getDateParameterGlobalVariableAndFetchFromSessionIfEmpty(String parameter, String sessionAttribute, String defval,ConnectionProvider conn) throws ServletException {
