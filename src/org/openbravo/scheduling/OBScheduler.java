...
public class OBScheduler {
  ...
  public void initialize(Scheduler schdlr) throws SchedulerException {
    ...
    try {
      // SZ: On Startup Set all Running Processes in the Log to Status ERROR (They have been running while Shutdown)
      ProcessRunData.UpdateExecutingToError(getConnection());
      // Load the sheduled Processes..
