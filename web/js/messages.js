...
function getDataBaseMessage(value, responseFunction) {
  ...
  submitXmlHttpRequestUrl(((responseFunction==null)?messageResponse:responseFunction), (getUrl() + "/businessUtility/MessageJS.html?inpvalue=JS" + encodeURI(value)), false, paramXMLReq)
}

function getDataBaseStandardMessage(value, responseFunction) {
  var paramXMLReq = null;
  submitXmlHttpRequestUrl(((responseFunction==null)?messageResponse:responseFunction), (getUrl() + "/businessUtility/MessageJS.html?inpvalue=" + encodeURI(value)), false, paramXMLReq)
}
