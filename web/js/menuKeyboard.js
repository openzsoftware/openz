...
function setMouseDown(obj) {
  var actualclass = obj.className;
/*var belements = document.getElementsByClassName("Normal NOT_Opened NOT_Hover NOT_Selected Pressed Focused");

    for(var i = belements.length - 1; i >= 0; --i)
    {
        // PERFORM STUFF ON THE ELEMENT
        belements[i].className = "Normal NOT_Opened NOT_Hover NOT_Selected Pressed NOT_Focused";

        // elements[i] no longer exists past this point, in most browsers
    } 
var celements = document.getElementsByClassName("Normal NOT_Opened NOT_Hover NOT_Selected Pressed NOT_Focused");

    for(var i = celements.length - 1; i >= 0; --i)
    {
        // PERFORM STUFF ON THE ELEMENT
        celements[i].className = "Normal NOT_Opened NOT_Hover NOT_Selected NOT_Pressed NOT_Focused";

        // elements[i] no longer exists past this point, in most browsers
    } */
var delements = document.getElementsByClassName("Normal NOT_Opened NOT_Hover NOT_Selected Pressed NOT_Focused");

    for(var i = delements.length - 1; i >= 0; --i)
    {
        // PERFORM STUFF ON THE ELEMENT
        delements[i].className = "Normal NOT_Opened NOT_Hover NOT_Selected NOT_Pressed NOT_Focused";

        // elements[i] no longer exists past this point, in most browsers
    }   
var eelements = document.getElementsByClassName("Normal NOT_Opened NOT_Hover NOT_Selected Pressed Focused");

    for(var i = eelements.length - 1; i >= 0; --i)
    {
        // PERFORM STUFF ON THE ELEMENT
        eelements[i].className = "Normal NOT_Opened NOT_Hover NOT_Selected NOT_Pressed NOT_Focused";
