...
class FieldLabelsData implements FieldProvider {
  ...
  public static FieldLabelsData[] select(ConnectionProvider connectionProvider, String ad_tab_id,
    ...
    strSql = strSql
        ...
        + "    , ad_getFieldText(field.ad_field_id,?) as FIELDTRL_NAME     "
        + "    , zssi_getElementTextByColumname(elemnt.columnname,?) as ELMTTRL_NAME "
        + "    , elemnt.printname  as ELMTTRL_PRINTNAME "
        + "    from         "
        + "    ad_column colum  "
        + "    , ad_field field   "
        + "    , ad_element elemnt         "
        ...
        + "    , elemnt.name as FIELD_NAME  " + "    , elemnt.name as FIELDTRL_NAME     "
        + "    , zssi_getElementTextByColumname(elemnt.columnname,?) as ELMTTRL_NAME        "
        + "    , elemnt.printname as ELMTTRL_PRINTNAME " + "    from               "
