...
class FormatRead extends DefaultHandler {
  ...
  public FormatRead(Hashtable<String, FormatCouple> hasFormats,String _decimalseparator, String _groupseparator) {
    this.hasFormats = hasFormats;
    this.decimalseparator=_decimalseparator;
    this.groupseparator=_groupseparator;
  }
